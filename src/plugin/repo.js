...
const searchRepo = async (m, Matrix) => {
  ...
  if (validCommands.includes(cmd)) {
    const repoUrl = `https://github.com/KAVIYAMD/KAVIYA-MD.git`;
              ...
              buttons: [
                {
                  ...
                  buttonParamsJson: JSON.stringify({
                    ...
                    url: 'https://wa.me/+94752689596?text=*Hey_KAVIYA_BOT_OWNER*',
                  }),
                },
                {
                  name: 'cta_url',
                  buttonParamsJson: JSON.stringify({
                    ...
                    url: 'https://github.com/KAVIYAMD/KAVIYA-MD/fork',
                  }),
                },
                {
                  name: 'cta_url',
                  buttonParamsJson: JSON.stringify({
                    ...
                    url: 'https://www.whatsapp.com/channel/0029VajrLTHKXN5O5Zj04',
                  }),
                },
              ],
            }),
