...
╰─────────────━┈⊷ `
            ...
            header: proto.Message.InteractiveMessage.Header.create({
                ...(await prepareWAMessageMedia({ image : fs.readFileSync('./src/KAVIYA.jpg')}, { upload: Matrix.waUploadToServer})), 
                  title: ``,
                  gifPlayback: true,
                  subtitle: "",
              ...
              buttons: [
                {
                 ...
                 "sections":
                   [{
                    "title":"ᴋᴀᴠɪʏᴀ-ᴍᴅ ᴍᴇɴᴜ",
                    "highlight_label":"ᴀʟʟ ᴍᴇɴᴜ",
                    "rows":[
                      {
                       "header":"",
                       "title":"ᴀʟʟ ᴍᴇɴᴜ",
                       "description":"ᴋᴀᴠɪʏᴀ-ᴍᴅ",
                       "id":"View All Menu"
                      },
                      {
                        "header":"",
...
╰━━━━━━━━━━━━━━━⪼
  ...
  image: fs.readFileSync('./src/KAVIYA.jpg'), 
  caption: str, 
  contextInfo: {
                  mentionedJid: [m.sender], 
                  forwardingScore: 999,
